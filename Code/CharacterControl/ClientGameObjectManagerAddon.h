...
struct ClientGameObjectManagerAddon : public GameObjectManagerAddon
{
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_CreateParticleSystem);
	virtual void do_CreateParticleSystem(PE::Events::Event* pEvt);
	...
	void createParticleSystem(Vector3 position, int &threadOwnershipMask);
